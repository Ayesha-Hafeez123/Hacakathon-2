  ...
  return (
    <>
     <div className='relative'>
        ...
        <h6 className="text-lg font-semibold leading-relaxed flex justify-center text-center items-center gap-2 p-3">Home <FaGreaterThan/><span className='font-light text-gray-700'>Blog</span> </h6>
      </div>
      </div>
