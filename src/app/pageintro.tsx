                ...
                {nav === "button" ?
                    ...
                    <div className={`flex items-center gap-3 ${nav === "none" ? 'hidden' : ""}`}>
                        <div className="w-10 h-10 rounded-full bg-[#F5F5F5] p-2">
                            <Image src={"/images/icons/navleft.png"} alt="navicon" width={600} height={600} className="w-full h-full object-contain" />
                        </div>
                        <div className="w-10 h-10 rounded-full bg-[#F5F5F5] p-2">
                            <Image src={"/images/icons/navright.png"} alt="navicon" width={600} height={600} className="w-full h-full object-contain" />
                        </div>
                    </div>}
            </div>
        </div>
